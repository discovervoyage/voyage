Contributing to Voyage Core
============================

The Voyage Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/voyage-project/voyage/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Voyage Core project, and is not to be
confused with overall Voyage Network Protocol consensus changes.

Whether a pull request is merged into Voyage Core rests with the project merge
...
Patches that change Voyage consensus rules are considerably more involved than
...
Where a patchset proposes to change the Voyage consensus, it must have been
...
The project leader is the release manager for each Voyage Core release.
