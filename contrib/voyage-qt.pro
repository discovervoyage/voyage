...
RESOURCES += src/qt/voyage.qrc src/qt/voyage_locale.qrc

TRANSLATIONS += src/qt/locale/voyage_bg.ts \
                src/qt/locale/voyage_de.ts \
                src/qt/locale/voyage_en.ts \
                src/qt/locale/voyage_es.ts \
                src/qt/locale/voyage_fi.ts \
                src/qt/locale/voyage_fr.ts \
                src/qt/locale/voyage_it.ts \
                src/qt/locale/voyage_ja.ts \
                src/qt/locale/voyage_pl.ts \
                src/qt/locale/voyage_pt.ts \
                src/qt/locale/voyage_ru.ts \
                src/qt/locale/voyage_sk.ts \
                src/qt/locale/voyage_sv.ts \
                src/qt/locale/voyage_vi.ts \
                src/qt/locale/voyage_zh_CN.ts \
                src/qt/locale/voyage_zh_TW.ts
