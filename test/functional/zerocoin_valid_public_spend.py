...
from fake_stake.base_test import Voyage_FakeStakeTest

class zVYGValidCoinSpendTest(Voyage_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zVYGs..." % DENOM_TO_USE)
