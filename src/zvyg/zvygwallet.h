...
#ifndef Voyage_ZVYGWALLET_H
#define Voyage_ZVYGWALLET_H
...
public:
    CzVYGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZVYG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVYG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
