...
#ifndef Voyage_ZVYGTRACKER_H
#define Voyage_ZVYGTRACKER_H
...
public:
    CzVYGTracker(std::string strWalletFile);
    ~CzVYGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzVYGWallet* zVYGWallet = NULL);
