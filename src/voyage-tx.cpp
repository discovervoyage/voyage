...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Voyage Core voyage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  voyage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded voyage transaction") + "\n" +
                               "  voyage-tx [options] -create [commands]   " + _("Create hex-encoded voyage transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded voyage transaction
