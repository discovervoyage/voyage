...
extern UniValue DoZvygSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzvygseed(const UniValue& params, bool fHelp);
extern UniValue getzvygseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzvyg(const UniValue& params, bool fHelp);
extern UniValue dzvygstate(const UniValue& params, bool fHelp);
