...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Voyage features */
        {"voyage", "listmasternodes", &listmasternodes, true, true, false},
        {"voyage", "getmasternodecount", &getmasternodecount, true, true, false},
        {"voyage", "masternodeconnect", &masternodeconnect, true, true, false},
        {"voyage", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"voyage", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"voyage", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"voyage", "masternodecurrent", &masternodecurrent, true, true, false},
        {"voyage", "masternodedebug", &masternodedebug, true, true, false},
        {"voyage", "startmasternode", &startmasternode, true, true, false},
        {"voyage", "createmasternodekey", &createmasternodekey, true, true, false},
        {"voyage", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"voyage", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"voyage", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"voyage", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"voyage", "getmasternodescores", &getmasternodescores, true, true, false},
        {"voyage", "preparebudget", &preparebudget, true, true, false},
        {"voyage", "submitbudget", &submitbudget, true, true, false},
        {"voyage", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"voyage", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"voyage", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"voyage", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"voyage", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"voyage", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"voyage", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"voyage", "checkbudgets", &checkbudgets, true, true, false},
        {"voyage", "mnsync", &mnsync, true, true, false},
        {"voyage", "spork", &spork, true, true, false},
        {"voyage", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzvygseed", &getzvygseed, false, false, true},
        {"zerocoin", "setzvygseed", &setzvygseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzvyg", &searchdzvyg, false, false, true},
        {"zerocoin", "dzvygstate", &dzvygstate, false, false, true},
...
{
    return "> voyage-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51257/\n";
}
