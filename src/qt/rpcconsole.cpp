                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVYGPathCustom = GetArg("-zvygbackuppath", "");
    ...
    if(!strzVYGPathCustom.empty()) {
        ui->wallet_customzvygbackuppath->setText(QString::fromStdString(strzVYGPathCustom));
        ui->wallet_customzvygbackuppath_label->setVisible(true);
        ui->wallet_customzvygbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVYGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Voyage RPC console.") + "<br>" +
