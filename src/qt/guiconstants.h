...
/* Voyage GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Voyage"
#define QAPP_ORG_DOMAIN "voyage.org"
#define QAPP_APP_NAME_DEFAULT "Voyage-Qt"
#define QAPP_APP_NAME_TESTNET "Voyage-Qt-testnet"
