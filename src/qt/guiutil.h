...
/** Utility functions used by the Voyage Qt UI.
 */
namespace GUIUtil
{
...
// Render Voyage addresses in monospace font
...
// Parse "voyage:" URI into recipient object, return true on successful parsing
