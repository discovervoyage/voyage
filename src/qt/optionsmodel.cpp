...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VYG);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeVoyageAmount"))
        SoftSetArg("-anonymizevoyageamount", settings.value("nAnonymizeVoyageAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in voyage.cpp during shotdown to also remove the window positions
